      ...
      className={cn(
        "sticky top-0 z-50 w-full border-b transition-all duration-200",
        {
          "bg-background/80 backdrop-blur-md border-border/40 shadow-sm":
            !scrolled,
          "bg-background/95 backdrop-blur-md border-border shadow-md": scrolled,
        },
      )}
    >
            ...
            <NavigationMenuList>
              <NavigationMenuItem>
                <NavigationMenuLink className="px-3" asChild>
                  <a
                    href="/"
                    className="hover:bg-accent rounded-md py-2 px-3 font-medium"
                  >
                    Beranda
                  </a>
                </NavigationMenuLink>
      ...
      >
        <div className="flex w-full flex-col">
          <a
            href="/"
            className="hover:bg-accent rounded-md p-3 font-medium text-base border-b border-border"
          >
            Beranda
          </a>
    ...
    <div className="flex flex-col">
      ...
      <AnimatePresence initial={false}>
        {isOpen && (
          ...
          >
            <div className="pl-4 border-l ml-2 space-y-1 my-1">{children}</div>
          </motion.div>
        )}
      </AnimatePresence>
    </div>
...
function MobileListItem({
  ...
  return (
    <a
      href={href}
      className={cn(
        "w-full flex flex-row gap-x-2 text-foreground hover:bg-accent hover:text-accent-foreground rounded-sm p-2",
        className,
      )}
      {...props}
    >
